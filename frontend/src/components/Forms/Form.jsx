          ...
          <div className="containerForm">
            ...
            <div>
              ...
              <input
                className="dataForm"
                type="text"
                onChange={(event) => onNombreChange(event)}
              />
            </div>
            ...
            <div>
              ...
              <input
                className="dataForm"
                type="text"
                onChange={(event) => onApellidoChange(event)}
              />
            </div>
            ...
            <div>
              ...
              <input
                className="dataForm"
                type="tel"
                onChange={(event) => onCelularChange(event)}
              />
            </div>
            ...
            <div>
              ...
              <input
                className="dataForm"
                type="text"
                onChange={(event) => onDireccionChange(event)}
              />
            </div>

            <button
              className="btnComprarForm"
              disabled={
                !(
                  nombre !== "" &&
                  apellido !== "" &&
    ...
    return (
      <>
        <div className="container">
          ...
          <Link to="/">
            <button>Empezá a comprar</button>
          </Link>
        </div>
      </>
    );
